		...
		<div class="container bg-light col-5">
          <form class="form-horizontal" name="myform" role="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="date" id="day" class="form-control" name="day" required autofocus>
                    </div>
                </div>
				...
				<div class="form-group">
                    <label for="nationalid" class="col-sm-3 control-label">Hour1</label>
                    <div class="col-sm-8">
                        <input type="text" id="hour1" class="form-control" name="hour1" required>
                    </div>
                </div>
				<div class="form-group">
                    <label for="nationalid" class="col-sm-3 control-label">Hour2</label>
                    <div class="col-sm-8">
                        <input type="text" id="hour2" class="form-control" name="hour2" required>
                    </div>
                </div>
				<div class="form-group">
                    <label for="nationalid" class="col-sm-3 control-label">Hour3</label>
                    <div class="col-sm-8">
                        <input type="text" id="hour3" class="form-control" name="hour3" required>
                    </div>
                </div>
				<div class="form-group">
                    <label for="nationalid" class="col-sm-3 control-label">Hour4</label>
                    <div class="col-sm-8">
                        <input type="text" id="hour4" class="form-control" name="hour4" required>
                    </div>
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                    <label for="nationalid" class="col-sm-3 control-label">Admin_id</label>
                    <div class="col-sm-8">
                        <input type="text" id="admin_id" class="form-control" name="admin_id" required>
                    </div>
                </div>
				...
				<div class="form-group">
					...
					<button type="submit" class="btn btn-primary ml-5" name="inserttimetable">Register</button>
